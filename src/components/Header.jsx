  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur-xl bg-[#0a0d14]/85 border-b border-slate-800/80 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="hidden xl:inline-block px-2 py-0.5 text-[10px] font-mono font-semibold uppercase tracking-widest bg-amber-500/10 text-amber-400 border border-amber-500/20 rounded-full">
                BYOK v1.0
              </span>
            </div>
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center gap-2 max-w-3xl mx-2 min-w-0">
          ...
          <div className="relative shrink-0 max-w-[170px]">
            <select
              value={model}
              onChange={(e) => setModel(e.target.value)}
              data-testid="model-selector-dropdown"
              className="w-full truncate appearance-none bg-slate-900/90 border border-slate-700/60 hover:border-slate-600 rounded-xl pl-2.5 pr-7 py-1.5 text-[11px] font-mono font-medium text-amber-400 focus:outline-none focus:border-amber-500/80 focus:ring-1 focus:ring-amber-500/50 cursor-pointer transition-all"
            >
          ...
          {/* Key Input Field */}
          <form onSubmit={handleSaveKey} className="flex-1 flex items-center min-w-[170px] max-w-xs gap-1">
            <div className="relative flex-1 min-w-0">
              <Key className="w-3.5 h-3.5 absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
              <input
                ...
                className="w-full pl-8 pr-7 py-1.5 bg-slate-900/90 border border-slate-700/60 rounded-xl text-[11px] font-mono text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/80 focus:ring-1 focus:ring-amber-500/50 transition-all truncate"
              />
              <button
                type="button"
            ...
            <button
              ...
              className="px-2.5 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono font-bold border border-amber-500/30 rounded-xl text-[11px] transition-all flex items-center gap-1 shrink-0 shadow-sm"
            >
              {savedSuccess ? (
                <>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 rounded-xl text-xs font-mono font-semibold transition-all"
      ...
      <div className="lg:hidden px-4 pb-3 flex flex-col gap-2 border-t border-slate-800/60 pt-2.5">
        ...
        <form onSubmit={handleSaveKey} className="flex items-center gap-1.5">
          ...
          <button
            type="submit"
            className="px-3 py-2 bg-amber-500 text-slate-950 rounded-xl text-xs font-mono font-bold shrink-0 hover:bg-amber-400 transition-colors"
          >
